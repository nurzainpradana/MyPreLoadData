package com.nurzainpradana.androidfundamental.mypreloaddata.service;
...
import com.nurzainpradana.androidfundamental.mypreloaddata.R;
...
import com.nurzainpradana.androidfundamental.mypreloaddata.pref.AppPreference;
...
public class DataManagerService extends Service {
    ...
    /* Method yang akan dipanggil ketika service diikatkan dengan activity */
    ...
    private void sendMessage(int messageStatus) {
    ...
    public static class LoadDataAsync extends AsyncTask<Void, Integer, Boolean> {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if(firstRun) {
                ...
                //Close helperketika proses query sudah selesai
        ...
        /*
        Parsing raw data text berupa data mnjadi array mahasiswa
